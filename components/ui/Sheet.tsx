        ...
        <SheetPortal>
            ...
            <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
                ...
                <SheetPrimitive.Close
                    className={cn(
                        'absolute right-4 top-4 rounded-sm opacity-70 transition-opacity data-[state=open]:bg-slate-100 hover:opacity-100 focus:outline-none disabled:pointer-events-none',
                        buttonClassName
                    )}
                >
